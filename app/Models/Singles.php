...
class Singles extends Model
{
    ...
    protected $fillable = ['id', 'album_id', 'title', 'slug', 'category_id', 'release_date', 'genre', 'spotify_url', 'youtube_embed', 'description', 'produced_by', 'recorded_at', 'created_at', 'updated_at'];
